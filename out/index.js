...
app.get('/', function (req, res) {
    User_1.User.find().then(function (lists) {
        getTypes().then(function (type) {
...
setTimeout(function () {
    User_1.User.find().then(function (data) {
        if (data.length == 0) {
            return;
        }
        var keys = Object.keys(data[0]);
        (0, typeorm_1.getMetadataArgsStorage)().columns.forEach(function (column) {
